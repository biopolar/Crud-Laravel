            ...
            <form action="{{ route('basic.update', $user->id) }}" method="post">
                ...
                <div class="form-group">
                  <label for="roles">Roles</label>
                    ...
                    <select type="roles" class="form-control @error('#') is-invalid @enderror" name="roles" id="roles" placeholder="Roles" required value="{{ old('roles') ?? $user->roles }}">
                      <option value="">Chose One</option>
                      <option value="Member" {{ ($user->roles == 'Member' ? 'selected="selected"' : '') }}>Member</option>
