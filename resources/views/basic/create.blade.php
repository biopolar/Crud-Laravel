        ...
        <div class="card-body">
            <form action="{{ route('basic.store') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="password_confirmation" placeholder="password confirmation" autocomplete="off">
                </div>

               <div class="form-group">
                <label for="roles">Roles</label>
                  <select type="roles" class="form-control @error('#') is-invalid @enderror" name="roles" id="roles" placeholder="Roles" required>
